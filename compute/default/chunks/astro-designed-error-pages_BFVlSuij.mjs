import { ao as NOOP_MIDDLEWARE_HEADER, ap as REDIRECT_STATUS_CODES, A as AstroError, aq as ActionsReturnedInvalidDataError, X as DEFAULT_404_COMPONENT } from './astro/server_CLkxvADI.mjs';
