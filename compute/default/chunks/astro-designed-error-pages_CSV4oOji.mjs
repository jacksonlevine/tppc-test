import { x as NOOP_MIDDLEWARE_HEADER, R as REDIRECT_STATUS_CODES, A as AstroError, y as ActionsReturnedInvalidDataError, D as DEFAULT_404_COMPONENT } from './astro/server_xtsaPTJy.mjs';
